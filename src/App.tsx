...
function App(props: AppProps) {
	...
	const joinRoom = async ({
		roomName, userName, signature
			...
			try {
				...
				await zmClient.join(roomName, signature, userName);
	...
	}, [zmClient, status, roomName, signature, userName]);
							...
							<Switch>
								...
								<Route
									...
									render={(props) => (
										...
										? <Video {...props} isLoggedIn={isLoggedIn}/>
										: <VideoSingle {...props} isLoggedIn={isLoggedIn}/>
									)}
